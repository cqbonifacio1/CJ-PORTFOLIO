...
// Originkit preset `variant-4` — wired in exactly as CJ provided it, only
// the `image` prop is overridden at the call site (in About.tsx) to point
// at the real mypicture.png instead of the broken preset blob: URL.
"use client";
...
const __originkitPresetProps = {
  "image": {
    "src": "blob:https://www.originkit.dev/89963a70-cc25-49f0-9013-daae8c5a1413"
  },
  "fit": "contain",
  "focusY": 14,
  "ramp": "",
